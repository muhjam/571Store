...
$products=query("SELECT * FROM pembelian ORDER BY kode_pembelian DESC");
...
<body>
			...
			<h1 style="text-align: center;font-family: "Libre Bodoni", sans-serif;color: #151e3d;">BandStore<span style=" color: red;font-size: 50px;">.</span></h1>
						<i style="text-align: center;font-family: "Libre Bodoni", sans-serif;color: #151e3d;">Laporan pembelian produk<span style=" color: red;font-size: 50px;">.</span></i>
...
foreach($products as $product){
	...
	<tr>
	<td>'.$i++.'</td>
	<td>'.date("d-m-Y", strtotime($product['tanggal_pembelian'])).'</td>
	<td>'.$product["kode_pembelian"].'</td>
...
$mpdf->WriteHTML($html);
$mpdf->Output('report-pembelian.pdf', 'I');
