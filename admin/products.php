...
<html>
	...
	<body class="hold-transition sidebar-mini">
			...
			<div class="content-wrapper">
				...
				<section class="content-header">
					<div class="container-fluid">
						<div class="row mb-2">
							<div class="col-sm-6">
								<h1>Produk Bandstore<span style="color:red">.</span></h1>
							</div>
						</div>
					</div><!-- /.container-fluid -->
				</section>
							...
							<div class="col-12">
								...
								<div class="card">
									<div class="card-header">
										...
										<a href="report_stok.php"><button type="submit" class="btn btn-light"><svg
													xmlns="http://www.w3.org/2000/svg" width="16" height="16" fill="currentColor"
		...
		$sql = mysqli_query($koneksi,"SELECT * FROM produk a, stok b WHERE a.kode_produk = b.kode_produk ORDER BY a.kode_produk DESC") or die(mysql_error());
				$no=0;
				...
				$kode_produk=$product['kode_produk'];
					?>
													...
													<td><?= $no; ?></td>
													<td><img src="../assets/img/<?= $product['gambar_produk']?>"
													...
													<td>
														<form action="products_edit.php" method="post"
															...
															<input type="hidden" value="<?= $product['kode_produk']; ?>" name="kode_produk">
														...
														<button type="button" class="btn btn-danger" title="Hapus Data" data-toggle="modal"
															data-target="#myModal4<?php echo $kode_produk; ?>"><svg xmlns="http://www.w3.org/2000/svg"
												...
												<div class="modal fade" id="myModal4<?php echo $kode_produk; ?>" role="dialog">
													<div class="modal-dialog">
														...
														<div class="modal-content">
															...
															<div class="modal-body">
																<?php
												include('assets/php/koneksi.php');
												$kode_produke = $kode_produk;
												$kueri = mysqli_query($koneksi, "SELECT * FROM produk a, stok b  WHERE a.kode_produk=b.kode_produk AND a.kode_produk='$kode_produke'") or die(mysql_error());
