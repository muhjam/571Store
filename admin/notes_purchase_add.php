...
if(tambah_pembelian($_POST)>0){
		 echo "
        <script>
        alert('Bukti pembelian berhasil ditambahkan!');
			...
			<div class="content-wrapper">
				...
				<section class="content-header">
					<div class="container-fluid">
						<div class="row mb-2">
							<div class="col-sm-6">
							<h1>Catat Pembelian<span style="color:red">.</span></h1>
							</div>
						</div>
					</div><!-- /.container-fluid -->
				</section>
											...
											<form action="" method="post">
												<div class="card-body">
													...
													<div class="form-group">
														...
														<input type="date" name="tanggal_pembelian" class="form-control" id="tanggal_pembelian" autocomplete="off"
															required>
													</div>
													<div class="form-group">
													...
													<div class="form-group">
														<label for="merk_produk">Brand</label>
														<input type="text" name="merk_produk" class="form-control" id="merk_produk"
															placeholder="Enter Brand" autocomplete="off" required maxlength="100">
													</div>
													<div class="form-group">
													...
													<div class="form-group">
														...
														<input type="number" name="jumlah_produk" class="form-control" placeholder="Enter Quantity"
															id="jumlah_produk" min="1" value="1" required>
													</div>
