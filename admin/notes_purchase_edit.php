			...
			<div class="content-wrapper">
				...
				<section class="content-header">
					<div class="container-fluid">
						<div class="row mb-2">
							<div class="col-sm-6">
								<h1>Ubah Catatan Pembelian<span style="color:red">.</span></h1>
							</div>
						</div>
					</div><!-- /.container-fluid -->
				</section>
											...
											<form action="" method="post">
												...
												<div class="card-body">
													...
													<div class="form-group">
														...
														<input type="date" name="tanggal_pembelian" class="form-control" id="tanggal_pembelian" autocomplete="off" value="<?= $pembelian['tanggal_pembelian']?>"
															required>
													</div>
													<div class="form-group">
